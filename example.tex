...
参考文献的引用采用 BibLaTeX 的方式生成 (内容写在文件 \verb|mybib.bib| 中), 参考文献格式为 \verb|shnuthesis-numeric| 参考了 清华大学 LaTeX 模板 \href{https://github.com/tuna/thuthesis}{\fbox{thuthesis}} 的一个格式, 去掉了文献的标号 [J], [M]等, 想要文献的标号可以选择  \verb|thuthesis-numeric| 格式, 也可以选择 plain 与  abbrv 格式.
